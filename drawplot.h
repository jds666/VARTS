...
public:
    //图2 折线图
    static void drawLineChart(QCustomPlot* Plot, const QVector<QString>& xdata,const QVector<QString>& ydata);
    //图3 散点图
    ...
    //图2 折线图
    static void drawLineChartByDB(QCustomPlot* Plot, const QVector<double> &xdata, const QVector<double> &ydata, QString xColumnName, QString yColumnName);
    //图3 散点图
